    ...
    def test_remove_scene_prop(self) -> None:
        ...
        try:
            with mock.patch(
                ...
                result = session.import_osm_categories(
                    project_id, categories=["trees"], **ANKARA_BBOX
                )
...
class TestImportOsmCategoriesApiLevel(unittest.TestCase):
        ...
        try:
            ...
            with mock.patch(
                ...
                response = router.dispatch(
                    "POST",
                    f"/api/projects/{project_id}/osm/import-layers",
                    body=body,
                )
    ...
    def test_delete_scene_prop_via_api(self) -> None:
        ...
        try:
            ...
            response = router.dispatch(
                "POST",
                f"/api/projects/{project_id}/scene-props/{key}/delete",
                body={},
            )
            self.assertEqual(response.status, 200)
