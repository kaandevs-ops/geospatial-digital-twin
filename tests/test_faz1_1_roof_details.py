...
class TestClimatePitchSuggestion:
    ...
    def test_snowy_zone_pitch_exceeds_arid_zone_pitch(self):
        assert RoofDetailGenerator.suggest_pitch_deg(
            "kutup"
        ) > RoofDetailGenerator.suggest_pitch_deg("kurak")
    ...
    def test_suggested_pitch_can_feed_directly_into_generate(self):
        ...
        mesh = RoofGenerator.generate(
            _rect_polygon(), base_z=0.0, roof_type="gable", pitch_deg=pitch
        )
