...
<h1 align="center">Harita Modelleme Platformu</h1>
<p align="center"><em>Geospatial Digital Twin Platform</em></p>

<p align="center">
  Turns building footprints, OSM/map data, and optional survey inputs into a <strong>parametric 3D digital twin of a city</strong> —
  with hazard simulation, mobility/crowd modeling, real-time multi-user collaboration, and CityGML/CityJSON/IFC export.
</p>

<p align="center">
  <a href="https://github.com/kaandevs-ops/geospatial-digital-twin/stargazers"><img src="https://img.shields.io/github/stars/kaandevs-ops/geospatial-digital-twin?style=flat-square&color=blue" alt="Stars"/></a>
  <a href="https://github.com/kaandevs-ops/geospatial-digital-twin/network/members"><img src="https://img.shields.io/github/forks/kaandevs-ops/geospatial-digital-twin?style=flat-square&color=blue" alt="Forks"/></a>
  <a href="https://github.com/kaandevs-ops/geospatial-digital-twin/commits/main"><img src="https://img.shields.io/github/last-commit/kaandevs-ops/geospatial-digital-twin?style=flat-square" alt="Last commit"/></a>
  <a href="https://github.com/kaandevs-ops/geospatial-digital-twin/blob/main/LICENSE"><img src="https://img.shields.io/badge/license-Apache%202.0-blue?style=flat-square" alt="License"/></a>
  <br/>
...
> [!NOTE]
> **License:** Apache License 2.0 — the root [`LICENSE`](LICENSE) file and `pyproject.toml` (`license = { text = "Apache-2.0" }`) agree. See [Project Status & License](#project-status--license).

> [!IMPORTANT]
> **Status: Beta.** Substantial real functionality exists across all 37 modules, but this README documents gaps as openly as features — see [Limitations](#limitations) before depending on this in production.
...
Each module ships its own `README.md` with implementation-level detail — see e.g. [`digital_twin/README.md`](digital_twin/README.md), [`mobility/README.md`](mobility/README.md), [`collaboration/README.md`](collaboration/README.md). 24 of the 37 modules currently have one.
...
<details open>
<summary><strong>Click to expand full module table</strong></summary>
...
<details>
<summary><strong>Optional extras</strong> (all documented in <code>pyproject.toml</code> with an explicit fallback/failure behavior when absent)</summary>
...
<details open>
<summary><strong>Hazard endpoints</strong></summary>
...
- **Module-level ownership** — 37 modules, each with a single responsibility; 24 currently have their own `README.md`.
...
<p align="center">
  <a href="https://star-history.com/#kaandevs-ops/geospatial-digital-twin&Date">
    <img src="https://api.star-history.com/svg?repos=kaandevs-ops/geospatial-digital-twin&type=Date" alt="Star History Chart" width="60%"/>
  </a>
</p>